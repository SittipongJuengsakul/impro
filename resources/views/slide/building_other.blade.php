<div style="background-color: white;">
            <div class="row">
                  <div class="col-md-3" style="margin-top: 50px;padding-left:20px"><h1>ค่าไฟฟ้าอาคาร อื่นๆ</h1>
                    <?php
                    $date = new DateTime();
                    ...
                    <table class="table" style="width:100%;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td width="50%" id="buildingo_est"></td>
                            </tr>
                            <tr>
                                <td>ปัจจุบันใช้</td>
                                <td id="buildingo_current"></td>
                            </tr>
                            <tr>
                                <td>เป็นเงิน</td>
                                <td id="buildingo_money"></td>
                            </tr>
                            <tr>
                                <td>ประมาณการเมื่อถึงสิ้นเดือน</td>
                                <td id="buildingo_esttomonth"></td>
                            </tr>
                        </tbody>
                    </table>
                  </div>
