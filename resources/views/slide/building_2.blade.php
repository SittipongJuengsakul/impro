<div style="background-color: white;">
            <div class="row">
                  <div class="col-md-3" style="margin-top: 50px;padding-left:20px"><h1>ค่าไฟฟ้าอาคาร 2</h1>
                    ...
                    <table class="table" style="width:100%;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td width="50%">{{ $Building2_arr[1] }} kWh</td>
                            </tr>
                            <tr>
                                <td>ปัจจุบันใช้</td>
                                <td>{{ $kwh_b1 = number_format($Building[1], 2) }} kWh</td>
                            </tr>
                            <tr>
                                <td>เป็นเงิน</td>
                                <?php $money = $Building[1]*$Building2_arr[0] ?>
                                <td>{{ number_format($money, 2) }} บาท</td>
                            </tr>
                            <tr>
                                <td>ประมาณการเมื่อถึงสิ้นเดือน</td>
                                <td>{{ number_format($Building2_arr[5], 2) }} kWh</td>
                            </tr>
                        </tbody>
                    </table>
                  </div>
                  <div class="col-md-9">
                    <div id="container-building-2" style="margin: 0 auto;min-height: 500px"></div>
                  </div>
                </div>
        </div>